...
$(document).ready(function(){
    ...
    //Execute on window resize
    $(window).resize(function() {
        if (!device.tablet() && !device.mobile() && !$("body").hasClass("is-popup") && isIE() != 1 && !$("body").hasClass("safari-mac")){
            desktop_nicescroll();
        }
    });
    ...
    var sticky_nav = function(){
        if (device.landscape() && $(window).width()<=640 && $(window).scrollTop() == 0 ) {
            ...
            $("#location_map").gMap({
                ...
                markers:
                    [
                        {
                            latitude: 21.3517493,
                            longitude: 106.0779873,
                            html: "<strong>Nhà Gái</strong><br/>Chợ Bỉ - Ngọc Thiện<br/>Huyện Tân Yên - Tỉnh Bắc Giang<br/><strong>GPS:</strong> 21.3517493, 106.0779873",
                            popup: true
                        },
                    ],
                panControl: true,
